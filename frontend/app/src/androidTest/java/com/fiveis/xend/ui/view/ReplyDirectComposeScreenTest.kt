...
class ReplyDirectComposeScreenTest {
    ...
    @Test
    fun replyDirectComposeScreen_displays_tap_complete_button() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
    ...
    @Test
    fun replyDirectComposeScreen_displays_formatting_controls() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
        ...
        // Then - Rich text editor controls should be displayed
    ...
    @Test
    fun replyDirectComposeScreen_bold_button_works() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
    ...
    @Test
    fun replyDirectComposeScreen_italic_button_works() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
    ...
    @Test
    fun replyDirectComposeScreen_underline_button_works() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
    ...
    @Test
    fun replyDirectComposeScreen_strikethrough_button_works() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
    ...
    @Test
    fun replyDirectComposeScreen_fontsize_dropdown_works() {
        // When
        composeTestRule.setContent {
            ReplyDirectComposeScreen(
                recipientEmail = "test@test.com",
        ...
        // Then
        composeTestRule.onNodeWithContentDescription("Font Size").performClick()
        Thread.sleep(200)
    }
